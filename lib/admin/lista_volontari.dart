...
import 'package:test_emad/admin/crea_nuovo_volontario.dart';
...
import 'package:test_emad/admin/profilo_volontari.dart';
import 'dart:convert';
...
class ListSearchState extends State<ListSearch> {
  ...
  Future<String> getActors() async {
    mainDataList.clear();
    var uri = Uri.parse('http://100.75.184.95:5000/lista_attori');
    print(uri);
