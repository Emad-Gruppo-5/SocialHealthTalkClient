...
void main() => runApp(const ProfiloVolontarioModifica());

/// This is the main application widget.
class ProfiloVolontarioModifica extends StatelessWidget {
  const ProfiloVolontarioModifica({Key? key}) : super(key: key);
