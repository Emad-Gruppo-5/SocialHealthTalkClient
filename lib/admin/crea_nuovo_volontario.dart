...
void main() => runApp(const CreaNuovoVolontario());

/// This is the main application widget.
class CreaNuovoVolontario extends StatelessWidget {
  const CreaNuovoVolontario({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Center(
            child: Text("Crea nuovo Volontario"),
          ),
        ),
